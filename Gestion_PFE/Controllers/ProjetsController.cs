...
namespace Gestion_PFE.Controllers
{
    public class ProjetsController : Controller
    {
        ...
        public ProjetsController(GestionContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.projets.Include(d=>d.Etudiant).Include(d=>d.Encadrant).ToListAsync());
        }
        ...
        public IActionResult Create()
        {
            ...
            list = _context.encadrants.ToList();
        ...
        public async Task<IActionResult> Create([Bind("ID,nameProjet,theme,description,EncadrantID,EtudiantID")] Projet projet)
        {
            ...
            ViewData["EtudiantID"] = new SelectList(_context.etudiants, "ID", "FullName", projet.EtudiantID);
            ViewData["EncadrantID"] = new SelectList(_context.etudiants, "ID", "FullName", projet.EncadrantID);
